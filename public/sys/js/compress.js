    ...
    return function(t) {
                    ...
                    value: function(t, e) {
                        function n(t, e) {
                            ...
                            return n.start = window.performance.now(),
                                ...
                                n.ext = t.type,
                                n.startSize = t.size,
                                p.default.orientation(t).then(function(e) {
                            ...
                            return function(e) {
                                return h.default.load(e).then(function(e) {
                                    ...
                                    return t.iterations = 1,
                                        ...
                                        r(e, t.startSize, t.quality, t.size, t.minQuality, t.iterations)
                                }).then(function(e) {
                                    return t.finalSize = d.default.size(e),
                                        d.default.data(e)
                                }).then(function(e) {
                        ...
                        function r(t, e) {
                            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1
                                ...
                                , s = d.default.size(u);
                            return o += 1,
                                s > i ? r(t, s, n - .1, i, a, o) : n > a ? r(t, s, n - .1, i, a, o) : n < .5 ? u : u
                        }
        ...
        , function(t, e, n) {
            ...
            !function(n, o) {
                ...
                var e = function(t) {
                    for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "image/jpeg", n = window.atob(t), i = [], r = 0; r < n.length; r++)
                        i[r] = n.charCodeAt(r);
                    ...
                    return i.width = t,
                        ...
                        function(a) {
                            if (!n || n > 8)
                                return r.drawImage(a, 0, 0, i.width, i.height),
                                    i;
                            ...
                            return n > 4 ? r.drawImage(a, 0, 0, i.height, i.width) : r.drawImage(a, 0, 0, i.width, i.height),
                                i
                        }
                }
                    , i = function(t) {
                            ...
                            i.onload = function(t) {
                                ...
                                for (var i = n.byteLength, r = 2; r < i; ) {
                                    ...
                                    65505 === a) {
                                        ...
                                        r += 2;
                                        for (var s = 0; s < u; s++)
                                            274 === n.getUint16(r + 12 * s, o) && e(n.getUint16(r + 12 * s + 8, o))
                                    } else {
                                        if (65280 !== (65280 & a))
                                            break;
                                        r += n.getUint16(r, !1)
