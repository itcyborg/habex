    ...
    <div class="modal fade bs-example-modal-lg in" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('/agronomist/farmer/upload')}}" method="post" enctype="multipart/form-data" id="frmupload">
                        {{csrf_field()}}
                    ...
                    <div class="sttabs tabs-style-iconbox">
                        ...
                        <div class="content-wrap">
                            ...
                            <section id="section-iconbox-3">
                                <div class="row p-10">
                                    <button class="btn btn-info btn-sm pull-right collapsed" type="button"
                                            data-toggle="collapse" data-target="#accountInfo" aria-expanded="false"
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="accountnameu"
                                                       name="accountnameu">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="accountnameu">Account Number</label>
                                                <input type="text" class="form-control" id="accountnumberu"
                                                       name="accountnumberu">
                                            </div>
                                        </div>
                                        <div class="row m-t-20">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="branchnameu"
                                                       name="branchnameu">
                                            </div>
                                        </div>
                                        <div class="row m-t-15">
                                            <button type="button" class="btn btn-primary btn-outline pull-right m-r-10"
                                                    onclick="Farmer.updateAccount()">
