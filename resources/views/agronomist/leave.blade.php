                        ...
                        <div class="white-box">
                            <div class="row row-in">
                                <div class="col-lg-4 col-sm-6 row-in-br">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-middle">
                                            <h4>Days Used</h4>
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: {{($leave->all-$leave->remaining)*100/$leave->all}}%">
                                ...
                                <div class="col-lg-4 col-sm-6 row-in-br  b-r-none">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-middle">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: {{($leave->all-$leave->used)*100/$leave->all}}%">
                                ...
                                <div class="col-lg-4 col-sm-6 b-0">
                                    <ul class="col-in">
                                        <li>
                                            <span class="circle circle-md bg-primary"><i class=" ti-calendar"></i></span>
                                        </li>
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15">
                                                @if($leave)
                                ...
                                <div class="col-md-12">
                                    <div class="panel">
                                        <form action="{{url('leave/request')}}" method="post">
                                            ...
                                            <div class="row">
                                                <label for="description">Description <i class="text-info">Further describe the reason for the leave</i></label>
                                                <textarea name="description" id="description" cols="30" rows="10"
                                                          class="form-control"></textarea>
                                            </div>
                                            <div class="row m-t-10">
                                                <button class="btn btn-1b btn-primary btn-outline pull-right"><i class="fa fa-caret-right"></i> Send Request</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
